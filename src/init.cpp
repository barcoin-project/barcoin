    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("Barcoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  barcoind [options]                     " + "\n" +
                  "  barcoind [options] <command> [params]  " + _("Send command to -server or barcoind") + "\n" +
                  "  barcoind [options] help                " + _("List commands") + "\n" +
                  "  barcoind [options] help <command>      " + _("Get help for a command") + "\n";
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -pid=<file>            " + _("Specify pid file (default: barcoind.pid)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Barcoin Wiki for SSL setup instructions)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. Barcoin is probably already running."), strDataDir.c_str()));
